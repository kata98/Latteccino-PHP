...
<body>
    ...
    <div id="drugi">
        <div id="booking">
            <form action="../models/korisnik/proveraUpdate.php" method="POST">
                <input type="hidden" name="id" id="id" value="<?=$korisnik_up->id ?>"/> 
                <input type="text" name="firstname2" placeholder="First name" value="<?=$korisnik_up->ime ?>" class="ime" id="ime"><br/>
                <input type="text" name="lastname2" placeholder="Last name" value="<?=$korisnik_up->prezime ?>" class="prezime" id="prezime"><br/>
                <input type="text" name="email2" placeholder="Email address" value="<?=$korisnik_up->email ?>" class="mejl1" id="mejl1"><br>
                <select name="uloga2" id="uloga" class="uloga"><option value="0">Choose role</option> 
                ...
                <?php
                    ...
                    foreach($uloge as $uloga):
                        if($korisnik_up->id == $korisnik_up->id_uloga) : ?>
                ...
                <input type="password" name="lozinka2" placeholder="Password" value="" class="lozinka" id="lozinka"><br>

                <input class="dugme" type="submit" value="UPDATE USER" name="update" id="update">
